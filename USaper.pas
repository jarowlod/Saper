...
begin
  ...
  //fpanel.Canvas.Brush.Color:= clLtGray;
  //fpanel.Canvas.Pen.Color:= clBlack;
  //fpanel.Canvas.Rectangle(0,0, img.Width+2, img.Height+2);
...
begin
  ...
  Width := Panel1.Left + Panel1.Width  + 10;
  Height:= Panel1.Top  + Panel1.Height + 10;
